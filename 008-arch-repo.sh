...
sudo pacman -S --noconfirm --needed tumbler virtualbox-host-modules-arch virtualbox vnstat w3m wget wmctrl unclutter rxvt-unicode urxvt-perls xdg-user-dirs xdo xdotool xfce4-notifyd 
